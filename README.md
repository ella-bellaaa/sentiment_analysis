...
1. How do you classify a new tweet? Give a short description of the main steps.
    ...
    > I count the number of positive and negative words in the tweet. If there are more positive words than negative words, it is positive, and vice versa.

2. What is the time complexity of your training implementation (Big-Oh notation)? Explain why.

   > O(N^2 * M) where N is the number of words in the training set, and M is the number of tweets

3. What is the time complexity of your classification implementation (Big-Oh notation)? Explain why.

   >  O(N^2 * M) where N is the number of words in the testing set, and M is the number of tweets

4. How do you know that you use proper memory management? That is that you do not have
   a memory leak?

   > I ran valgrind and had minimal memory leaks. I also used the rule of three in every object where dynamic memory was used

5. What was the most challenging part of the assignment?

   > The string class was the most challenging for me because it was my first large project doing dynamic memory.
